...
def convert_to_spans(seq):
    ...
    if not seq:
        ...
        times = seq[0].split("-")
        return insert_span(convert_to_spans(seq[1:]),
                           new_time_span(convert_time(times[0]),
...
def time_spans_to_calendar_day(mts):
    ...
    if is_empty_time_spans(mts):
        ...
        return insert_appointment(
                   new_appointment(first_time_span(mts), new_subject("Test")),
                   time_spans_to_calendar_day(rest_time_spans(mts)))
...
def is_same_time_spans(mts1, mts2):
    ...
    if is_empty_time_spans(mts1) and is_empty_time_spans(mts2):
        ...
        return False
    elif is_same_span(first_time_span(mts1), first_time_span(mts2)):
        return is_same_time_spans(
                   rest_time_spans(mts1),
                   rest_time_spans(mts2))
    else:
        return False
...
def new_cases():
    ...
    """
    Vi tycker dessa testfall är tillräckliga då det täcker alla edgecases
    vi kan tänka på och ett generellt fall.
    """
    #General test
    new_test_case(
        2,
        "00:00",
        "23:00",
        ["08:15-10:00", "13:15-17:00"],
        ["00:00-08:15", "10:00-13:15", "17:00-23:00"])
    ...
    #test appointment overlap with start time
    new_test_case(
        5,
        "08:00",
        "17:00",
    ...
    #test appointment overlap with end time
    new_test_case(
        6,
        "08:00",
        "17:00",
    ...
    #Appointment "back to back"
    new_test_case(
        7,
        "08:00",
        "17:00",
        ["09:00-10:00", "10:00-12:27", "15:16-16:00"],
        ["08:00-09:00", "12:27-15:16", "16:00-17:00"])

    #appointment end at end of span we check
    new_test_case(
        8,
        "08:00",
        "17:00",
    ...
    #appointment start at end of span
    new_test_case(
        9,
        "08:00",
        "17:00",
    ...
    #appointment end at start of span
    new_test_case(
        10,
        "08:00",
        "17:00",
        ["03:00-04:15", "07:00-08:00", "10:00-14:00"],
        ["08:00-10:00", "14:00-17:00"])

    #Appointments outside span
    new_test_case(
        11,
        "12:00",
        "15:00",
        ["03:00-04:00", "07:00-09:00", "13:00-14:00", "16:38-17:22", \
         "22:00-23:00"],
